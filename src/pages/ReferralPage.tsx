    ...
    <div className="min-h-screen bg-[#0B0D18] text-slate-100">
      ...
      <main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_0.8fr]">
          <div className="rounded-[24px] border border-white/10 bg-[#151823] p-8 shadow-sm">
            <h3 className="text-2xl font-semibold text-white">How it works</h3>
            <div className="mt-6 space-y-4 text-sm text-slate-300">
              <div className="rounded-[16px] bg-[#1B1F2B] p-4">1. Share your link with friends.</div>
              <div className="rounded-[16px] bg-[#1B1F2B] p-4">2. They make their first purchase.</div>
              <div className="rounded-[16px] bg-[#1B1F2B] p-4">3. You both receive reward credits.</div>
            </div>
